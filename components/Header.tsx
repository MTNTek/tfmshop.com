  ...
  return (
    <header className="bg-[#000f0a] text-white">
        ...
        <div className="flex items-center justify-between py-2 md:py-3">
          ...
          <div className="flex-1 max-w-2xl mx-4">
            <div className="relative flex">
              ...
              <Button 
                className="bg-orange-400 hover:bg-orange-500 text-black rounded-l-none px-4"
                suppressHydrationWarning={true}
              >
          ...
          <div className="flex items-center space-x-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button 
                  variant="ghost" 
                  className="text-white hover:bg-[#001f14] flex flex-col items-start p-2"
                  suppressHydrationWarning={true}
                >
            ...
            <Button 
              variant="ghost" 
              className="text-white hover:bg-[#001f14] flex flex-col items-start p-2 hidden md:flex"
              suppressHydrationWarning={true}
            >
            ...
            <Button 
              variant="ghost" 
              className="text-white hover:bg-[#001f14] relative p-2"
              suppressHydrationWarning={true}
            >
      ...
      <div className="md:hidden bg-[#001f14] max-w-[1440px] mx-auto px-4 py-2">
        <Button 
          variant="ghost" 
          className="text-white hover:bg-[#000f0a]"
          suppressHydrationWarning={true}
        >
