...
import { Search, ShoppingCart, Menu, User, Heart, Package, MapPin, ChevronDown } from 'lucide-react';
      ...
      <div className="max-w-[1440px] mx-auto px-4">
        <div className="flex items-center justify-between py-2 md:py-3">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/" className="text-lg md:text-xl font-bold hover:text-gray-200">
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            {/* Wishlist */}
            <Link href="/wishlist">
              <Button variant="ghost" className="text-white hover:bg-[#001f14] flex flex-col items-center p-2">
            ...
            <Link href="/cart">
              <Button variant="ghost" className="text-white hover:bg-[#001f14] relative p-2">
                <div className="flex items-end">
                  <ShoppingCart className="w-6 md:w-8 h-6 md:h-8" />
